...
`hpc-compose` is a Rust CLI for turning a Compose-like spec into a single Slurm job. [`src/main.rs`](/Users/nicolas/hpc-compose/src/main.rs) is the CLI entrypoint; core behavior lives in [`src/spec.rs`](/Users/nicolas/hpc-compose/src/spec.rs), [`src/planner.rs`](/Users/nicolas/hpc-compose/src/planner.rs), [`src/prepare.rs`](/Users/nicolas/hpc-compose/src/prepare.rs), [`src/preflight.rs`](/Users/nicolas/hpc-compose/src/preflight.rs), [`src/render.rs`](/Users/nicolas/hpc-compose/src/render.rs), [`src/cache.rs`](/Users/nicolas/hpc-compose/src/cache.rs), and [`src/job.rs`](/Users/nicolas/hpc-compose/src/job.rs). End-to-end coverage lives in [`tests/cli.rs`](/Users/nicolas/hpc-compose/tests/cli.rs). User-facing docs belong in [`docs/`](/Users/nicolas/hpc-compose/docs), and runnable sample specs live in [`examples/`](/Users/nicolas/hpc-compose/examples).

## Build, Test, and Development Commands
- `cargo build --release`: build the production binary.
- `cargo test`: run the full test suite.
- `cargo test --test cli`: run CLI integration tests only.
- `cargo test --test cli submit_command_runs_end_to_end_with_fake_tools -- --exact`: run one integration test while debugging.
