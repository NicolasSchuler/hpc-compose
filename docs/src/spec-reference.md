...
| `artifacts` | mapping | Optional post-job artifact collection and export settings. Disabled by default. |
...
- Omit the block to disable tracked artifact collection entirely.
