...
- If you change cache keys, artifact naming, or prepared-image semantics in code, the docs (`docs/spec-reference.md`, `docs/runbook.md`) and cache behavior should be updated together.
