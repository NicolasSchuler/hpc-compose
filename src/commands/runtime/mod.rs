...
pub(super) use hpc_compose::job::{
    ...
    detect_sweep_drift, expand_sweep_with_limit, export_artifacts, find_submission_record_in_repo,
    generate_sweep_id, interpolation_vars_for_sweep_trial, jobs_dir_for,
