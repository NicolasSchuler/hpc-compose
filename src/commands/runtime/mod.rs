...
pub(super) use hpc_compose::job::{
    ...
    build_efficiency_score_report, build_job_diff_report, build_job_matrix_report,
    build_metrics_probe_report, build_ps_snapshot, build_replay_report, build_rightsize_report,
    build_spec_diff_report, build_stats_snapshot, build_stats_snapshot_with_status,
    build_status_snapshot, build_status_snapshot_with_array, build_status_snapshot_with_status,
    build_submission_record_with_backend_and_options, build_submission_record_with_options,
    compose_file_sha256, detect_sweep_drift, expand_sweep_with_limit, export_artifacts,
    find_submission_record_in_repo, generate_sweep_id, interpolation_vars_for_sweep_metadata,
    interpolation_vars_for_sweep_trial, jobs_dir_for, latest_canary_record_path_for,
    latest_notebook_record_path_for, latest_record_path_for, latest_run_record_path_for,
    load_submission_record, load_submission_record_optional, load_sweep_manifest,
    metadata_root_for, parse_log_since_duration, pid_is_running, print_logs,
    ...
    scan_sweep_manifests, serialize_metrics_probe_report, state_path_for_record,
