...
pub use sweep::{
    ...
    SweepManifestTrial, detect_sweep_drift, expand_sweep, expand_sweep_with_limit,
    generate_sweep_id, interpolation_vars_for_sweep_trial, latest_sweep_manifest_path_for,
    load_sweep_manifest, resume_trial_positions, scan_sweep_manifests, sweep_manifest_path_for,
